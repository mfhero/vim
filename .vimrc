...
func SetTitle() 
	...
	if &filetype == 'sh' 
		...
		call append(line(".")+4, '# Mail: 1400012705@pku.edu.cn') 
    ...
    elseif &filetype == 'python'
		...
		call append(line(".")+5, '# Mail: 1400012705@pku.edu.cn') 
...
"        call setline(1,"<head><meta charset=\"UTF-8\"></head>")
		...
		call append(line(".")+2, "	> Mail: 1400012705@pku.edu.cn") 
